...
export const PaymentOpt = () => {
  ...
  const {id} = useParams();
  const getData = ()=>{
    axios.get(`https://oppo-backend.herokuapp.com/products/Audio/${id}`).then(({data})=>{
        setItem(data)
    })
  }
  useEffect(()=>{
      ...
      <div className="main_payment_container_div">
        <div className="left_payment_div">
          ...
          <div className="left_thired_div">
            <h5>
              Total Payable Amount {Math.floor(item.price-(item.price*(item.offer/100)))}
              <button
          ...
          <div className="hide_div">
            <div className="left_subtotal_div">
              <p>Subtotal</p>
              <h5>{Math.floor(item.price-(item.price*(item.offer/100)))}</h5>
            </div>
          </div>
        ...
        <div className="right_payment_div">
          <div className="right_top_div">
            ...
            <select name="" id="" style={{padding: '0px 3%'}}>
          ...
          <div className="payment_card_div">
            <ul className="ul_list_paymnet">
              ...
              >
                <span className="img_ul_li">
                  <img
                    src="https://api.payu.in/public/assets/images/card-icon.svg"
                    alt=""
                  />
                </span>
                <span>Card (Credit/Debit)</span>
                <br />
                <small className="small_li_">
                  Visa, Mastercard,DinersClub,Rupay, Amex
                </small>
                <span className="icon_li">
                  <FaAngleRight />
                </span>
              </li>

              <li className="firts_li">
                <span className="img_ul_li">
                  <img
                    src="https://api.payu.in/public/assets/images/cardless.svg"
                    alt=""
                  />
                </span>
                <span>EMI </span>
                <br />
                <small className="small_li_">Credit Card</small>
                <span className="icon_li2">
                  <FaAngleRight />
                </span>
              </li>
              ...
              <li className="firts_li">
                <span className="img_ul_li">
                  <img
                    src="https://api.payu.in/public/assets/images/net-banking-icon.svg"
                    alt=""
                  />
                </span>
              ...
              <li className="firts_li">
                <span className="img_ul_li">
                  <img
                    src="https://api.payu.in/public/assets/images/wallet-icon.svg"
                    alt=""
                  />
                </span>
                <span>Wallet</span>
                <br />
                <small className="small_li_">Gpay, PhonePe,BHIM, Paytm</small>
                <span className="icon_li4">
                  <FaAngleRight />
                </span>
              </li>
            </ul>
