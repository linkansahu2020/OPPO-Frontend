  ...
  return (
   <>
     <div className="footer">
                  <div> 
                     <h4> SmartPhones</h4>
                      {footer.SmartPhones.map((item,index)=>(
                  ...
                  <div>
                 <h4> Iot Products</h4>
                  {footer.IotProducts.map((item,index)=>(
                         <a key={item.url} href={item.url}>{item.name} </a>
                  ...
                  <div>
                   <h4> Specialoffers</h4>
                    {footer.Specialoffers.map((item,index)=>(
                         <a key={item.url} href={item.url}>{item.name}</a>
                  ...
                  <div>
                 <h4> AboutOppo</h4>
                  {footer.AboutOppo.map((item,index)=>(
                         <a key={item.url} href={item.url}>{item.name}</a>
                 ...
                 <h4> oppo community</h4>
                  {footer.OppoCommunity.map((item,index)=>(
                         <a key={item.url} href={item.url}>{item.name}</a>
